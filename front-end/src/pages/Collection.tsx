...
const Collection = () => {
  ...
  const { productList , search , showSearch } = useContext(ShopContext) as ShopContextType;
    ...
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='flex-1'>
        ...
        <div className='flex justify-between text-base sm:text-2xl mb-4'>
            ...
            {/* Porduct Sort */}
            <select onChange={(e)=>setSortType(e.target.value as 'relavent' | 'low-high' | 'high-low')} className='border-2 border-gray-300 text-sm px-2'>
